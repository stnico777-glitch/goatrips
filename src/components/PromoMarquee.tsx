...
export function PromoMarquee() {
  ...
  return (
    <div
      className="relative flex h-[var(--promo-marquee-height)] items-center overflow-hidden border-y border-collectible/25 bg-rich-earth text-[10px] font-semibold uppercase tracking-[0.22em] text-precious md:text-[11px]"
      aria-hidden
    >
